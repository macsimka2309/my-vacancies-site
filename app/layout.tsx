...
export const metadata: Metadata = {
  ...
  // Подтверждение прав на домен. Тот же код уже лежит файлом в public/, но
  // файловый способ подтверждает только Вебмастер: другие сервисы Яндекса
  // спрашивают метатег. Ключ один, поэтому оба способа не конфликтуют.
  verification: {
    yandex: "fa2e0ed38472edb5",
  },
