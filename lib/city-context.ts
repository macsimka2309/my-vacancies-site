...
// «Универсал» — это «Курьер (универсал)» (п. 9: жаргон таблицы «Ларгус»
// из названия убран, здесь заменяем ту же метку).
const NEEDS_OWN_TRANSPORT = /на авто|на велосипеде|на мото|универсал/i;
