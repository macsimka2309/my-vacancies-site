...
// «На а/м» — это «Курьер на а/м (универсал)» (п. 9: жаргон таблицы
// «Ларгус» из названия убран, здесь заменяем ту же метку).
const NEEDS_OWN_TRANSPORT = /на авто|на велосипеде|на мото|на а\/м/i;
