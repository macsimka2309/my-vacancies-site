...
const INTENT_WHERE: Record<IntentMatch, object> = {
  ...
  // «Курьер на велосипеде», «на электровелосипеде», «на мото», «(вело/мото)»
  // — четыре разных названия одного и того же требования: свой велосипед,
  // электровелосипед, мотоцикл или скутер вместо автомобиля.
  ownBike: {
    OR: [
      { title: { contains: "велосипед", mode: "insensitive" } },
      { title: { contains: "мото", mode: "insensitive" } },
    ],
  },
