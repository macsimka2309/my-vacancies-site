...
TYPES = {
    ...
    # Название вакансии на сайте — «Курьер (большой багажник)» (без жаргона
    # «Ларгус», см. п. 9); ключ словаря должен совпадать с title на сайте,
    # а не с формулировкой таблицы.
